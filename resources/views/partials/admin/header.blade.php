        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block user-dropdown">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="rounded-circle header-profile-user" src="{{ Avatar::create(ucwords(strtoupper(auth()->user()->username)))->toBase64() }}" alt="User Avatar">
                    <span class="d-none d-xl-inline-block ms-1">{{ ucwords(auth()->user()->username) }}</span>
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <form id="logout-form" action="{{ route('logout') }}" method="POST" class="dropdown-item text-danger">
                        @csrf
