                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('update.profile') }}" method="POST" class="mt-3" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" name="name" type="text" value="{{ ucwords(strtolower($profile->name)) }}" id="name-text-input">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="username-text-input" class="col-sm-2 col-form-label">Username</label>
                                <div class="col-sm-10">
                                    <input class="form-control" name="username" type="text" value="{{ $profile->username }}" id="username-text-input">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="email-text-input" class="col-sm-2 col-form-label">Email</label>
                                <div class="col-sm-10">
                                    <input class="form-control" name="email" type="email" value="{{ $profile->email }}" id="email-text-input">
                                </div>
                            </div>
                            <div class="row mb-3">
